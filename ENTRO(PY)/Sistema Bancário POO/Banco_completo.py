...
class ContaPoupanca(Conta):
    def __init__(self, numero, cliente, senha, limite=2000, limite_saques=1):
        super().__init__(numero, cliente, senha)
        self._limite = limite
        self._limite_saques = limite_saques
...
class Saque(Transacao):
    ...
    def registrar(self, conta):
        sucesso_transacao = conta.sacar(self.valor, conta._senha)
...
class Deposito(Transacao):
    ...
    def registrar(self, conta):
        sucesso_transacao = conta.depositar(self.valor, conta._senha)
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if tipo_conta.lower() == "corrente":
        ...
        conta = ContaPoupanca.nova_conta(cliente=cliente, numero=numero_conta, senha=senha)
    else:
